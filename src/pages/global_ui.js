...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  // Global Music (consistent across tabs)
  ...
  audio.addEventListener("error", (e) => {
    ...
    alert(
      "Audio element error: " + (audio.error ? audio.error.message : "Unknown"),
    );
  });

  // Try autoplay, if blocked catch ANY interaction on the page
  // I SWEAR theres a way to autoplay, i KNOW IT!! WHY CANT I FIND IT
  audio
    .play()
    .then(() => {
      musicStarted = true;
